/**
 * @generated SignedSource<<37d2dccc311bc5c087b4aa8e687e3529>>
...
export type CommentsUpdateWithQuery$variables = Record<PropertyKey, never>
export type CommentsUpdateWithQuery$data = {
  readonly target:
    | {
...
export type CommentsUpdateWithQuery = {
  response: CommentsUpdateWithQuery$data
  variables: CommentsUpdateWithQuery$variables
}
...
const node: ConcreteRequest = (function () {
  ...
  return {
    ...
    params: {
      cacheID: 'cacf3130ee38b6466ce5acb673b7bce8',
      id: null,
      metadata: {
