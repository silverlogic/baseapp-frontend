/**
 * @generated SignedSource<<9d174a543f3ff2c1c4566d65f60233d6>>
...
export type CommentsForTestingQuery$variables = Record<PropertyKey, never>;
export type CommentsForTestingQuery$data = {
  readonly target: {
    readonly " $fragmentSpreads": FragmentRefs<"CommentsFragment">;
  } | null | undefined;
};
export type CommentsForTestingQuery = {
  response: CommentsForTestingQuery$data;
  variables: CommentsForTestingQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "1b17e21396b3429eed413e765e7845c6",
    "id": null,
    "metadata": {
