/**
 * @generated SignedSource<<48df1dafc9c1e1e278dc7a73ef65e8e0>>
...
export type CommentsWithQuery$variables = Record<PropertyKey, never>;
export type CommentsWithQuery$data = {
  readonly target: {
    readonly " $fragmentSpreads": FragmentRefs<"CommentsFragment">;
  } | null | undefined;
};
export type CommentsWithQuery = {
  response: CommentsWithQuery$data;
  variables: CommentsWithQuery$variables;
};
...
(node as any).hash = "64b3a06f269b694de19ac7c4ca12ab26";
