/**
 * @generated SignedSource<<49a5d4fd8535ca2c639873a20b7999a8>>
...
export type ContentPostsPaginationQuery$variables = {
  count?: number | null | undefined;
  cursor?: string | null | undefined;
  orderBy?: string | null | undefined;
};
export type ContentPostsPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"ContentPostsFragment">;
};
export type ContentPostsPaginationQuery = {
  response: ContentPostsPaginationQuery$data;
  variables: ContentPostsPaginationQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ContentPostsPaginationQuery",
    "selections": [
      {
        "args": [
          {
