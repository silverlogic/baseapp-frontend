...
const ApplePhoneIcon: FC<SvgIconProps> = ({ sx, ...props }) => (
  <SvgIcon sx={{ fontSize: 64, ...sx }} {...props}>
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="18" y="3" width="29" height="58" rx="4" fill="url(#paint0_linear_4388_113146)" />
      <rect
        x="18"
        y="3"
        width="29"
