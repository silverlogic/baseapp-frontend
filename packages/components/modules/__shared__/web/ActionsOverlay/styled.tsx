...
export const ActionOverlayTooltipContainer = styled(Box, {
  shouldForwardProp: (prop) => prop !== 'offsetTop' && prop !== 'offsetRight',
})<ActionOverlayTooltipContainerProps>(({ theme, offsetTop = 0, offsetRight = 0 }) => ({
