...
const GroupChatDetails = () => {
  ...
  const { handleViewPhotoLibrary, handleTakePhoto } = useViewPhotoLibrary({
    ...
    onResult: (image?: ImagePicker.ImagePickerAsset) => {
      ...
      groups.setGroupChat({ ...groups, image: imageUri })
    },
    onFinally: () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Button mode="outlined" textColor="high" onPress={handlePresentModalPress}>
          Change Avatar
        </Button>
        <Button mode="text" color="error" onPress={() => handleRemoveImage('image')}>
          Remove
        </Button>
      </View>
