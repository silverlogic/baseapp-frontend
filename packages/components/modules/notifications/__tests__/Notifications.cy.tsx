...
import CustomNotificationItemForTest from './__utils__/CustomNotificationItemForTest'
import CustomNotificationListForTest from './__utils__/CustomNotificationListForTest'
import NotificationsForTesting from './__utils__/NotificationsForTesting'
...
describe('Notifications', () => {
  it('should render show notification drawer with empty state', () => {
    ...
    cy.mount(<NotificationsForTesting environment={environment} />).then(() => {
  ...
  it('should render custom components for list', () => {
    ...
    cy.mount(
      <NotificationsForTesting
        environment={environment}
        NotificationsList={CustomNotificationListForTest}
      />,
    ).then(() => {
      resolveMostRecentOperation({
        data: unreadNotificationsMockData,
    ...
    cy.mount(
      <NotificationsForTesting
        ...
        NotificationsListProps={{
          NotificationItem: CustomNotificationItemForTest,
        }}
      />,
    ).then(() => {
      resolveMostRecentOperation({
