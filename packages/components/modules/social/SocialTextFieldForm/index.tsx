...
import { SocialTextFieldFormProps } from './types'

const SocialTextFieldForm = forwardRef<HTMLInputElement, SocialTextFieldFormProps>(
  (
    {
      placeholder = 'Message...',
      autoFocusInput,
...
export default SocialTextFieldForm
