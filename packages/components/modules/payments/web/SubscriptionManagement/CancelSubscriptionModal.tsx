    ...
    <CancelSubscriptionModalContainer>
      ...
      <Box sx={{ py: '12px' }}>
        <Typography variant="body1" gutterBottom color="text.secondary">
          Are you sure you want to cancel your subscription? You will retain access to your current
          plan until the end of the billing period. After that, your account will be downgraded to
          the free plan.
        </Typography>
      </Box>
