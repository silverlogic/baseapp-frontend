...
import type { UseAllAuthTOTPAuthenticate } from './types'

const useAllAuthTOTPAuthenticate = ({
  formOptions = {},
  mutationOptions = {},
  accessKeyName = ACCESS_KEY_NAME,
  refreshKeyName = REFRESH_KEY_NAME,
  enableFormApiErrors = true,
}: UseAllAuthTOTPAuthenticate) => {
  /*
  ...
  const mutation = useMutation({
    mutationFn: (data: AllAuthTypes.TOTPAuthenticateRequest) => AllAuthApi.mfaAuthenticate(data),
...
export default useAllAuthTOTPAuthenticate
